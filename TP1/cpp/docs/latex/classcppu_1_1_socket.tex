...
\begin{DoxyCode}{0}
\DoxyCodeLine{42 \{Failed = -1, InvalidSocket = -2, UnknownHost = -3\};}
...
Definition at line 26 of file cppsocket.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{26                          :}
\DoxyCodeLine{27   \textcolor{comment}{// - family is AF\_INET (other families such as AF\_UNIX or AF\_INET6 are not supported)}}
\DoxyCodeLine{28   \textcolor{comment}{// - type can be SOCK\_STREAM (TCP/IP) or SOCK\_DGRAM (datagram connection)}}
\DoxyCodeLine{29   \textcolor{comment}{// - protocol is 0 (meaning it is chosen automatically)}}
\DoxyCodeLine{30   \_sockfd(::socket(\textcolor{comment}{/*family*/}AF\_INET, type, \textcolor{comment}{/*protocol*/}0))}
\DoxyCodeLine{31   \{}
\DoxyCodeLine{32     \textcolor{comment}{// ignore SIGPIPES when possible}}
\DoxyCodeLine{33 \textcolor{preprocessor}{\#if defined(SO\_NOSIGPIPE)}}
\DoxyCodeLine{34     \textcolor{keywordtype}{int} set = 1;}
\DoxyCodeLine{35     setsockopt(\_sockfd, SOL\_SOCKET, SO\_NOSIGPIPE, (\textcolor{keywordtype}{void}*)\&set, \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{int}));}
...
Definition at line 68 of file cppsocket.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{68                            \{}
\DoxyCodeLine{69     \textcolor{keywordflow}{if} (\_sockfd < 0) \textcolor{keywordflow}{return} InvalidSocket;}
\DoxyCodeLine{70     \textcolor{comment}{// for INET4 sockets}}
\DoxyCodeLine{71     \textcolor{keyword}{struct }sockaddr\_in addr;}
\DoxyCodeLine{72     \mbox{\hyperlink{classcppu_1_1_socket_a73d529332eae6048b321b381354e6bea}{setLocalAddress}}(addr, port);}
\DoxyCodeLine{73     \textcolor{comment}{// assigns the address specified by addr to sockfd (returns -1 on error, 0 otherwise)}}
\DoxyCodeLine{74     return ::bind(\_sockfd, (\textcolor{keyword}{const} \textcolor{keyword}{struct} sockaddr*)\&addr, \textcolor{keyword}{sizeof}(addr));}
\DoxyCodeLine{75   \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{95                     \{}
\DoxyCodeLine{96     \textcolor{keywordtype}{int} stat = 0;}
\DoxyCodeLine{97     \textcolor{keywordflow}{if} (\_sockfd >= 0) \{}
\DoxyCodeLine{98       stat = ::shutdown(\_sockfd, SHUT\_RDWR);  \textcolor{comment}{// SHUT\_RDWR=2}}
\DoxyCodeLine{99       stat += \mbox{\hyperlink{classcppu_1_1_socket_ab958ef8a0f0495cf3a1c57a2ad4a34fc}{::close}}(\_sockfd);}
\DoxyCodeLine{100     \}}
\DoxyCodeLine{101     \_sockfd = -1;}
\DoxyCodeLine{102     \textcolor{keywordflow}{return} stat;}
\DoxyCodeLine{103   \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{86                                                   \{}
\DoxyCodeLine{87     \textcolor{keywordflow}{if} (\_sockfd < 0) \textcolor{keywordflow}{return} InvalidSocket;}
\DoxyCodeLine{88     \textcolor{comment}{// for INET4 sockets}}
\DoxyCodeLine{89     \textcolor{keyword}{struct }sockaddr\_in addr;}
\DoxyCodeLine{90     \textcolor{keywordflow}{if} (\mbox{\hyperlink{classcppu_1_1_socket_aec26c9f6372f7ed2ec383fc98cbb6458}{setAddress}}(addr, host, port) < 0) \textcolor{keywordflow}{return} UnknownHost;}
\DoxyCodeLine{91     \textcolor{comment}{// connects sockfd to the address specified by addr (returns -1 on error, 0 otherwise)}}
\DoxyCodeLine{92     return ::connect(\_sockfd, (\textcolor{keyword}{struct} sockaddr*)\&addr, \textcolor{keyword}{sizeof}(addr));}
\DoxyCodeLine{93   \}}
...
Definition at line 111 of file cppsocket.\+h.


\begin{DoxyCode}{0}
\DoxyCodeLine{111                                                           \{}
\DoxyCodeLine{112       return ::recv(\_sockfd, buf, len, flags);}
\DoxyCodeLine{113     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{130                                                                        \{}
\DoxyCodeLine{131       return ::recvfrom(\_sockfd, buf, len, flags, src\_addr, addrlen);}
\DoxyCodeLine{132     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{97                                                              \{}
\DoxyCodeLine{98       return ::send(\_sockfd, buf, len, \_NO\_SIGPIPE(flags));}
\DoxyCodeLine{99     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{120                                                                         \{}
\DoxyCodeLine{121       return ::sendto(\_sockfd, buf, len, \_NO\_SIGPIPE(flags), dest\_addr, addrlen);}
\DoxyCodeLine{122     \}}
